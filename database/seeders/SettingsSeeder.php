...
class SettingsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $items = [
            ...
            ['site_information', 'Celta Educare'],

            ['site_phone', '01-5907931'],
            ['site_email', 'celta@gmail.com'],
            ['site_location', 'Kathmandu, Nepal'],
            ['site_location_url', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d440.57915189381816!2d85.32309917747837!3d27.668628534399804!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb193be21aea5b%3A0xaa83ef792abf1f63!2sCelta%20Educare%20Consultancy!5e1!3m2!1sen!2snp!4v1744195769373!5m2!1sen!2snp'],
            ['site_mail', 'mail.celta.com.np'],
            ['site_url', '/'],

            ['site_copyright', 'Celta'],
            ...
            ['contact_description', 'Celta'],

            ['contact_location', 'Chitwan, Kathmandu'],
            ['contact_email', 'info@celta.com'],
            ...
            ['contact_seo_title', 'Celta'],
            ['contact_seo_description', 'Celta'],
            ['contact_seo_keywords', 'Celta'],
            ['contact_seo_schema', 'Celta'],
            ...
            ['homepage_seo_title', 'celta'],
            ['homepage_seo_keywords', 'celta'],
            ['homepage_meta_description', 'celta'],
            ['homepage_seo_schema', 'celta'],
